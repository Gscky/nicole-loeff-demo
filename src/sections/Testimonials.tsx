            ...
            <div className="inline-flex items-center gap-3 sm:gap-4 bg-white rounded-2xl px-5 sm:px-8 py-4 sm:py-5 shadow-sm border border-gray-100">
              ...
              <div className="flex flex-col items-start">
                <div className="flex items-center gap-2">
                  <span className="font-display text-3xl font-bold text-gray-dark">{GOOGLE_RATING}</span>
                  <div className="flex items-center gap-0.5">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star key={i} size={18} className="fill-copper-400 text-copper-400" />
                    ))}
                  </div>
                </div>
                <span className="font-body text-sm text-gray-500">en Google</span>
              </div>
            </div>
          </ScrollReveal>
        </div>
