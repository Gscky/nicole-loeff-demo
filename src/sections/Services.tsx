          ...
          {SPECIALTIES.map((spec, i) => {
            ...
            return (
              <ScrollReveal key={spec.id} delay={i * 0.08}>
                <div className="group rounded-2xl bg-white border border-gray-100 p-6 h-full transition-all duration-300 hover:shadow-xl hover:shadow-copper-400/10 hover:border-copper-200 hover:-translate-y-1">
                  {/* Icon */}
