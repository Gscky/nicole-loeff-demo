export const CLINIC = {
  ...
  whatsappLink: 'https://wa.me/56912345678?text=Hola%20Dra.%20Nicole%2C%20me%20gustar%C3%ADa%20agendar%20una%20hora%20en%20la%20cl%C3%ADnica%20%F0%9F%98%8A',
...
export const BEFORE_AFTER_CASES = [
  {
    ...
    description: 'Reparación de desgaste y pequeñas fracturas en dientes anteriores mediante resinas compuestas de alta estética para un resultado natural.',
    image: '/images/cases/caso-1.jpg',
  },
  {
    id: 2,
    title: 'Reconstrucción de Dientes Fracturados',
    description: 'Rehabilitación de incisivos superiores fracturados y dañados con restauraciones de resina compuesta, devolviendo forma y función natural.',
    image: '/images/cases/caso-2.jpg',
  },
  {
    id: 3,
    title: 'Cierre de Diastema',
    description: 'Eliminación del espacio entre los dientes frontales mediante resinas compuestas, logrando una sonrisa más armónica y uniforme.',
    image: '/images/cases/caso-3.jpg',
  },
  {
    id: 4,
    title: 'Carillas de Resina Compuesta',
    description: 'Corrección de forma e irregularidades dentales con carillas de resina, mejorando la simetría y estética de la sonrisa.',
    image: '/images/cases/caso-4.jpg',
  },
  {
    id: 5,
    title: 'Diseño de Sonrisa',
    description: 'Armonización dental mediante carillas estéticas para lograr una sonrisa más equilibrada y natural.',
    image: '/images/cases/caso-5.jpg',
  },
  {
    id: 6,
    title: 'Rehabilitación Estética Completa',
    description: 'Transformación completa de la sonrisa con carillas de porcelana, cierre de diastemas y blanqueamiento para un resultado impecable.',
    image: '/images/cases/caso-6.jpg',
  },
  {
    id: 7,
    title: 'Coronas Dentales',
    description: 'Restauración de piezas dentales desgastadas con coronas de porcelana de alta estética, devolviendo función y apariencia natural.',
  ...
  {
    id: 9,
    title: 'Restauración con Resina',
    description: 'Corrección de desgaste e irregularidades en dientes anteriores superiores mediante resinas compuestas de alta estética.',
    image: '/images/cases/caso-9.jpg',
  },
  {
    id: 10,
    title: 'Reconstrucción de Incisivos',
    description: 'Rehabilitación de incisivos superiores fracturados y dañados, devolviendo forma, color y función natural.',
    image: '/images/cases/caso-10.jpg',
  },
  {
    id: 11,
    title: 'Cierre de Diastema Frontal',
    description: 'Eliminación del espacio entre dientes frontales con resinas compuestas para una sonrisa más armónica y uniforme.',
    image: '/images/cases/caso-11.jpg',
  },
  {
    id: 12,
    title: 'Carillas de Alineación',
    description: 'Corrección de irregularidades y alineación dental mediante carillas de resina compuesta de alta estética.',
    image: '/images/cases/caso-12.jpg',
  },
  {
    id: 13,
    title: 'Carillas Estéticas Superiores',
    description: 'Mejora de forma, tamaño y alineación de los dientes superiores con carillas estéticas de aspecto natural.',
    image: '/images/cases/caso-13.jpg',
  },
  {
    id: 14,
    title: 'Blanqueamiento y Carillas',
    description: 'Combinación de blanqueamiento dental profesional y carillas estéticas para una transformación completa de la sonrisa.',
    image: '/images/cases/caso-14.jpg',
  },
  {
    id: 15,
    title: 'Coronas Laterales',
    description: 'Restauración de piezas laterales desgastadas con coronas de porcelana de alta estética y durabilidad.',
    image: '/images/cases/caso-15.jpeg',
  },
  {
    id: 16,
    title: 'Implante y Cierre de Espacio',
    description: 'Reemplazo de pieza dental perdida mediante implante y cierre de espacios interdentales.',
    image: '/images/cases/caso-16.jpeg',
  },
  {
    id: 17,
    title: 'Rehabilitación Oral Completa',
    description: 'Transformación integral de la sonrisa con rehabilitación de múltiples piezas dentales superiores e inferiores.',
    image: '/images/cases/caso-17.jpeg',
  },
  {
    id: 18,
    title: 'Rehabilitación Inferior Severa',
    description: 'Reconstrucción completa del arco inferior con severo desgaste y acumulación de sarro, devolviendo salud y estética.',
    image: '/images/cases/caso-18.jpeg',
  },
  {
    id: 19,
    title: 'Carillas Inferiores',
    description: 'Corrección de irregularidades y manchas en dientes inferiores mediante carillas de resina compuesta.',
    image: '/images/cases/caso-19.jpeg',
  },
  {
    id: 20,
    title: 'Ortodoncia y Alineación',
    description: 'Corrección de apiñamiento dental y mejora de la alineación para una sonrisa equilibrada y funcional.',
    image: '/images/cases/caso-20.jpeg',
  },
  {
    id: 21,
    title: 'Rehabilitación Estética Masculina',
    description: 'Restauración completa de la sonrisa masculina con carillas y coronas de porcelana de aspecto natural.',
    image: '/images/cases/caso-21.jpeg',
  },
  {
    id: 22,
    title: 'Reconstrucción Completa Superior',
    description: 'Rehabilitación integral del arco superior con coronas y carillas para una transformación total de la sonrisa.',
    image: '/images/cases/caso-22.jpeg',
  },
  {
    id: 23,
    title: 'Carillas Laterales Estéticas',
    description: 'Mejora de la vista lateral de la sonrisa con carillas de porcelana, corrigiendo prominencia y alineación.',
    image: '/images/cases/caso-23.jpeg',
  },
  {
    id: 24,
    title: 'Rehabilitación Periodontal',
    description: 'Tratamiento periodontal completo con rehabilitación estética en caso de severo deterioro dental.',
    image: '/images/cases/caso-24.jpeg',
  },
  {
    id: 25,
    title: 'Carillas de Diseño de Sonrisa',
    description: 'Diseño personalizado de sonrisa con carillas estéticas para lograr armonía, simetría y naturalidad.',
    image: '/images/cases/caso-25.jpeg',
  },
  {
    id: 26,
    title: 'Corrección de Apiñamiento',
    description: 'Resolución de apiñamiento dental severo mediante ortodoncia y carillas para una sonrisa alineada.',
    image: '/images/cases/caso-26.jpeg',
  },
  {
    id: 27,
    title: 'Carillas y Blanqueamiento Integral',
    description: 'Transformación completa con blanqueamiento profesional y carillas estéticas de alta calidad.',
    image: '/images/cases/caso-27.jpeg',
  },
] as const;
