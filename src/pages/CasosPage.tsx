                ...
                <div className="group rounded-2xl overflow-hidden bg-white shadow-md border border-gray-100 hover:shadow-xl transition-all duration-500">
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 flex gap-2">
                      <span className="bg-gray-dark/70 backdrop-blur-sm text-white text-xs font-body font-medium px-3 py-1.5 rounded-full">
                        Antes
                      </span>
                      <span className="bg-emerald-500/80 backdrop-blur-sm text-white text-xs font-body font-medium px-3 py-1.5 rounded-full">
                        Despues
                      </span>
                    </div>
                  </div>
                  <div className="p-6">
                    <h3 className="font-display text-xl font-semibold text-gray-dark mb-2">
                      {item.title}
                    </h3>
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 font-body text-sm font-semibold text-copper-400 hover:text-copper-500 transition-colors"
                    >
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 rounded-full bg-copper-400 px-10 py-4 font-body text-base font-semibold text-white transition-all duration-300 hover:bg-copper-500 hover:shadow-xl hover:shadow-copper-400/30 hover:scale-[1.02]"
            >
              Agendar evaluacion
            </a>
          </ScrollReveal>
